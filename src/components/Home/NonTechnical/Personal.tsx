...
const Personal = () => {
	return (
		<div className="space-y-10">
			<div>
				<ScrambleText text="Hi, I'm Nicolas." settings={{ speed: 1 }} className="text-orange-500 font-medium text-xl mb-2 block" />
				<ScrambleText text="21. at Stanford. Trying to learn and grow and build beautiful things with others. focussed on biological interfaces and hardware solutions to help humans regain sight and movement" settings={{ speed: 1 }} className="text-orange-500 font-medium" />
			</div>
			...
			<motion.div animate={{ opacity: 1, x: 0 }}>
				<motion.ul variants={animations.containerVariants} initial="hidden" animate="show" className="space-y-10">
					<motion.li variants={animations.itemVariants} className="body">
						<Link text="nicozez@stanford.edu" href="mailto:nicozez@stanford.edu" className="text-orange-500" />
					</motion.li>
					...
					<motion.li variants={animations.itemVariants} className="body">
                        ...
                        <div> Analog Circuits, Signal Processing, Embedded Systems, Digital System Design, Linear Dynamical Systems</div>
					</motion.li>
